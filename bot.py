...
@bot.command()
async def mem1(ctx):
    with open('M2L1\memler\mem1.png', 'rb') as f:
...
@bot.command()
async def mem2(ctx):
    with open('M2L1\memler\mem2.png', 'rb') as f:
        # Dönüştürülen Discord kütüphane dosyasını bu değişkende saklayalım!
        picture = discord.File(f)
   # Daha sonra bu dosyayı bir parametre olarak gönderebiliriz!
    await ctx.send(file=picture)
...
@bot.command()
async def mem3(ctx):
    with open('M2L1\memler\mem3.png', 'rb') as f:
        # Dönüştürülen Discord kütüphane dosyasını bu değişkende saklayalım!
        picture = discord.File(f)
   # Daha sonra bu dosyayı bir parametre olarak gönderebiliriz!
    await ctx.send(file=picture)
...
@bot.command()
async def mem4(ctx):
    with open('M2L1\memler\mem4.jpg', 'rb') as f:
        # Dönüştürülen Discord kütüphane dosyasını bu değişkende saklayalım!
        picture = discord.File(f)
   # Daha sonra bu dosyayı bir parametre olarak gönderebiliriz!
    await ctx.send(file=picture)
...
async def random_mem(ctx):
    memler = os.listdir('M2L1\memler')
    secilen_mem = random.choice(memler)
    with open(f'M2L1\memler/{secilen_mem}', 'rb') as f:
        # Dönüştürülen Discord kütüphane dosyasını bu değişkende saklayalım!
        picture = discord.File(f)
   # Daha sonra bu dosyayı bir parametre olarak gönderebiliriz!
    await ctx.send(file=picture)
...
async def animals(ctx):
    hayvanlar = os.listdir('M2L1\hayvanlar')
    secilen_hayvan = random.choice(hayvanlar)
    with open(f'M2L1\hayvanlar/{secilen_hayvan}', 'rb') as f:
        # Dönüştürülen Discord kütüphane dosyasını bu değişkende saklayalım!
        picture = discord.File(f)
   # Daha sonra bu dosyayı bir parametre olarak gönderebiliriz!
    await ctx.send(file=picture)
